...
function MD5(string) {
  ...
  function FF(a, b, c, d, x, , ac) { a = AddUnsigned(a, AddUnsigned(AddUnsigned(F(b, c, d), x), ac)); return AddUnsigned(RotateLeft(a, ), b); }
  function GG(a, b, c, d, x, , ac) { a = AddUnsigned(a, AddUnsigned(AddUnsigned(G(b, c, d), x), ac)); return AddUnsigned(RotateLeft(a, ), b); }
  function HH(a, b, c, d, x, , ac) { a = AddUnsigned(a, AddUnsigned(AddUnsigned(H(b, c, d), x), ac)); return AddUnsigned(RotateLeft(a, ), b); }
  function II(a, b, c, d, x, , ac) { a = AddUnsigned(a, AddUnsigned(AddUnsigned(I(b, c, d), x), ac)); return AddUnsigned(RotateLeft(a, ), b); }
  ...
  function WordToHex(lValue) {
    ...
    for (let i = 0; i <= 3; i++) {
      ...
      out += ("0" + lByte.toString(16)).slice(-2);
    }
    return out;
  }
...
(async () => {
  try {
    ...
    notify("脚本异常", String(e && e.message ? e.message : e));
  } finally {
    finish({});
  }
})();
